...
export function SubscriptionCard({
  ...
  return (
    <div>
      {popular && (
        <Text className="p-1 bg-red-500 font-bold text-center uppercase">
      ...
      <SubHead
        subhead
        className={`text-4xl p-3 ${popular ? 'bg-red-500' : 'bg-black'}`}
      >
        {title}
      </SubHead>
      <div className="bg-zinc-400 flex justify-between p-3 items-center">
        <div>
          <Text className="text-zinc-500 text-2xl">{text}</Text>
          {price && (
